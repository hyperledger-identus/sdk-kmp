...
import org.hyperledger.identus.walletsdk.domain.models.PublicKey
...
class PolluxMock : Pollux {
    ...
    override fun extractCredentialFormatFromMessage(formats: Array<AttachmentDescriptor>): CredentialType = extractedCredentialFormatFromMessageReturn ?: throw Exception("Return not defined")
    ...
    override suspend fun extractEcPublicKeyFromVerificationMethod(coreProperty: DIDDocumentCoreProperty): Array<org.hyperledger.identus.walletsdk.domain.models.keyManagement.PublicKey> {
        TODO("Not yet implemented")
    }
